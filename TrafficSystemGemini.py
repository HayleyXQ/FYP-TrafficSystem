...
# -----------------------------
    ...
    if st.button("📄 Generate PDF Report"):
        ...
        for vis in selected_vis:
            ...
            pdf.multi_cell(0, 10, safe_pdf_text(vis_explanation_plain))
            pdf.ln(5)
        
        # Footer
        pdf.set_font("Times", "", 10)
        #pdf.cell(0, 10, "This report was generated by the Smart City Traffic System.", ln=True, align='C')
        pdf.cell(0, 10, safe_pdf_text("This report was generated by the Smart City Traffic System."), ln=True, align='C')
